        ...
        {this.props.list.map(o=>(
          <TouchableOpacity key={o.id} style={{
              ...
              <View style={{width:50,justifyContent:'center', marginLeft:15}}>
                <Text style={{fontSize:15, color:'#000'}}>{o.type}</Text>
              </View>
              <View style={{width:50,justifyContent:'center', marginLeft:15}}>
                <Text style={{fontSize:15, color:'#000'}}>{o.place}</Text>
              </View>
              <View style={{flex:1,justifyContent:'center', marginLeft:15}}>
                <Text style={{fontSize:15, color:'#000'}}>{o.date}</Text>
              </View>
